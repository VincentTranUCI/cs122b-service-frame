...
public class Microservice {
    ...
    // and a description, sends a POST request; returns a response model
    public static ResponseModel requestPost(RequestModel requestModel, Class<? extends ResponseModel> responseClass,
    ...
    // Used for communication between microservices; takes a request model, a response class, path information,
    // and a description, sends a GET request; returns a response model
    public static ResponseModel requestGet(Class<? extends ResponseModel> responseClass, String servicePath, String endpointPath, String desc) {
        ServiceLogger.LOGGER.info("Sending request to " + desc + "...");
        ...
        try {
            ...
            ResponseModel responseModel = Endpoint.MAPPER.readValue(jsonText, responseClass);
            ServiceLogger.LOGGER.info("Successfully mapped response to POJO.");
            return responseModel;
        } catch (IOException e) {
            ServiceLogger.LOGGER.warning("Unable to map response to POJO.");
